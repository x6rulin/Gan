...
class Train:
    ...
    def __init__(self, dataset, gnet, dnet, save_dir, sample_num=128, batch_size=32, num_workers=4):
        ...
        self.img_dir = os.path.join(save_dir, r'iamges/')
...
if __name__ == "__main__":
    ...
    trainer = Train(dataset, Generator, Discriminator, save_dir, batch_size=64)
    trainer(freq=32)
